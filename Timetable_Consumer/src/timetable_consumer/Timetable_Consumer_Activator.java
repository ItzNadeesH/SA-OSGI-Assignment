...
public class Timetable_Consumer_Activator implements BundleActivator {
    ...
    public void start(BundleContext context) throws Exception {
        ...
        serviceReference1 = context.getServiceReference(TeacherService.class.getName());
        tservice = (TeacherService) context.getService(serviceReference1);
    ...
    private void handleActions() {
        ...
        while (running) {
            System.out.println("--------------Choose an option from Timetable Management--------------");
